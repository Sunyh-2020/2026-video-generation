...
from prompt_kling import update_withoutexp_prompt
...
def build_prompt_block(cloth_title, raw_prompt, metric):
    """
    拼成你之前单条 demo 里的那种格式
    """
    score_text = (
...
def main():
    ...
    for idx, video in enumerate(videos, 1):
        ...
        print(update_withoutexp_prompt)
        print(prompt_block)
